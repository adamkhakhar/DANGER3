...
after testing approximately $5.6 \times 10^{12}$ candidates in 52 minutes on 16 RTX 5090 GPUs.  The source code is available [here](https://github.com/adamkhakhar/pomerance-triple-search).
